...
public class PostagemFragment extends Fragment {
    ...
    private Button buttonAbrirGaleira, buttonAbrirCamera;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonAbrirGaleira = view.findViewById(R.id.buttonAbrirGaleria);
        ...
        buttonAbrirGaleira.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
